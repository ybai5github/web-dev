        ...
        <>
            ...
            <div className="pt-2 row">
                ...
                <div className="col-11">
                    <textarea className="form-control wd-border-bottom ms-3 wd-100-div bg-black text-white" placeholder="What's happening?"
                              onChange={(e) =>
                    ...
                    {/*    Tweet*/}
                    {/*</button>*/}
                    <button className="float-end btn-primary wd-rounded-corners2" onClick={() => createTuit(dispatch, newTuit)}>
                        Tweet
                    </button>
                </div>
